...
<head>
    ...
    <title>DRIVE EASY SCHOOL - Beginner's Course</title>
    <link rel="stylesheet" href="../css/BeginnerCourse.css">
</head>
<body>
<header>
...
<main class="main-container">
    <section class="course-detail-section">
        <div class="course-detail-header">
            <h2 class="course-detail-title">Beginner's Course</h2>
...
<script src="../js/BeginnerCourse.js"></script>
</body>
</html>